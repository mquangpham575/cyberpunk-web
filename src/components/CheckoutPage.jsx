...
const CheckoutPage = ({ cart, total, onBack, onClearCart, user }) => {
  ...
  // Handle 'Escape' key press to close checkout
  useEffect(() => {
  ...
  return (
    <motion.div
      ...
      // Ensure high z-index for overlay
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      ...
                      <input
                        ...
                        // Check user existence before accessing display name
                    ...
                    {paymentMethod === "credit" ? (
                      ...
                      <div className="border border-green-500/30 bg-green-500/5 p-6 flex flex-col items-center text-center space-y-3">
                        ...
                        <p className="text-gray-400 text-xs font-mono max-w-sm">
                          ...
                          khi nhận hàng để đảm bảo giao dịch diễn ra nhanh
                          chóng.
                        </p>
                      </div>
                    )}
